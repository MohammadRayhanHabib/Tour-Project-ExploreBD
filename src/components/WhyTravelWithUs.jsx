        ...
        <section className="w-full px-6 py-20 ">
            <div className="max-w-7xl mx-auto text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                    {/* Card 1 */}
                    <div className="bg-[#1a2639] border border-teal-500/20 rounded-2xl p-8 hover:shadow-xl transition-all">
                    ...
                    {/* Card 2 */}
                    <div className="bg-[#1a2639] border border-violet-500/20 rounded-2xl p-8 hover:shadow-xl transition-all">
                    ...
                    {/* Card 3 */}
                    <div className="bg-[#1a2639] border border-rose-500/20 rounded-2xl p-8 hover:shadow-xl transition-all">
                    ...
                    {/* Card 4 */}
                    <div className="bg-[#1a2639] border border-yellow-400/20 rounded-2xl p-8 hover:shadow-xl transition-all">
                    ...
                    {/* Card 5 */}
                    <div className="bg-[#1a2639] border border-sky-500/20 rounded-2xl p-8 hover:shadow-xl transition-all">
                    ...
                    {/* Card 6 */}
                    <div className="bg-[#1a2639] border border-fuchsia-400/20 rounded-2xl p-8 hover:shadow-xl transition-all">
